"""
ビームフォーミング法およびmusic法による到来方向推定
製作者: 1610396 高場 雄太, 1610507 橋本 陸
"""
import argparse
import numpy as np
...
parser.add_argument("--save", default="save", help="プロット画像を保存するかどうか save: 保存する, show: 見るだけ")
parser.add_argument("--seed", default="random", help="シード値設定 random: 乱数指定 fix: 1に固定")
...
if __name__ == "__main__":
    ...
    if args.seed not in ['random', 'fix']:
        raise ValueError("'seed' must be 'random' or 'fix'")
